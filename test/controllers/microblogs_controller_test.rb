...
class MicroblogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create microblog" do
    assert_difference('Microblog.count') do
      post microblogs_url, params: { microblog: { blog: @microblog.blog, user: @microblog.user } }
    end
  ...
  test "should update microblog" do
    patch microblog_url(@microblog), params: { microblog: { blog: @microblog.blog, user: @microblog.user } }
